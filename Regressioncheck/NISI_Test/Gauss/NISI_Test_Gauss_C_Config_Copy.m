...
nameMeasFolder   = '1'; %Handle to identify different measurements in one folder
...
Pre_Calc_Measurement  = 0 ; %|>> Filters and reduction etc    
                                                                                              
                                                                                              
Sensor             = [ 0    % |Analyse a specific sensor / surface      
                       0 ]; % |combination                              
Penetration_Time   = 0.02;  % |Thermal penetration time in s                              
Future_Time_Window = 0.02;  % |Width in s of the analysation window counting from       
                            % |Penetration_Time , if =0 -> Only the timestep                 
                            % |at Penetrationtime + 1*timestep is considered                 
Timestep_Reduction_C = 100  ; % Only every Timestep_Reduction timestep is used for Calibration        
Timestep_Reduction_M = 100  ; % Only every Timestep_Reduction timestep is used for Measurement        
