...
%% Path Configuration
nameCalFolder    = 'Gauss_Noise'; % <- Calibration data are supposed to be located in separate calibration folder
nameMeasFolder   = 'Msrt_Gauss_Noise'; %Handle to identify different measurements in one folder
...
Timestep_Reduction_C = 2  ; % Only every Timestep_Reduction timestep is used for Calibration        
Timestep_Reduction_M = 2  ; % Only every Timestep_Reduction timestep is used for Measurement        
...
Filter_Config = [ 5    % Calibration Temperature Data  | 0 >>> No Filter            
                  ...
                  5    % Measurement Temperature Data  | 2 >>> Running Gauss Filter 
...
FIR_Config    = [ 1500    % Calibration Temperature Data 
                  ...
                  0    % Measurement Temperature Data 
                  0    % Impulse Response             
...
Solver_Configuration = 3;        % 0 - phased Van Cittert      
