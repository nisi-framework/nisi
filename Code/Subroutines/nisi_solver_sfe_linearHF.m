...
%------------------------------------------------------------------------
  ...
  for handle_Sensor = 1:Msrmnt_Points
         ...
         for i = 1:Future_Time_Steps    % Hier entsteht der Zähler in Beck Gl. 4.4.34
